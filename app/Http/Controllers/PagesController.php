...
class PagesController extends Controller
{
    public function index()
    {
        ...
        // $navbar = Menu::where('idparent',1)->with(str_repeat('getSubmenu.',5))->get();
        $navbar = Menu::with('getSubmenu')->where('idparent',1)->get();
        $aside = Menu::with(str_repeat('getSubmenu.',5))->where('idparent',10)->orderBy('nourut', 'asc')->get();


        return view('pages.dashboard',['navbar' => $navbar], ['aside' => $aside], compact('page_title', 'page_description'));
    }
